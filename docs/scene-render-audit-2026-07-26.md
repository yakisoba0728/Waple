...
- **3D 씬 텍스트 미배선**: SceneRenderer3D.swift:446 — 사이드이펙트만 실행(3509243656의 40+ 텍스트).
- **칸 메라 프레이밍 불일치**: 3477054430(달 프러스텀 밖 — 5:1 광폭에선 보임, fov/종횡 해석).
...
| 스프라이트시트 NPOT .tex | 3407317466 | 디코드 실패(RGB 스트라이프) |
