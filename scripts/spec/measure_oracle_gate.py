...
def main():
    ...
    entries_out = [
        ...
        specfmt.entry("oracle.gate.selfCheckIsIntraProcess", {
            ...
            "measured": {
                "method": "macOS 검증 2026-08-01 — **같은 커밋·같은 빌드**로 전체 코퍼스를 두 번 캡처해 대조",
                "nonDeterministicScenes": 29,
            ...
            "lesson": "이 저장소에서 안전망이 조용히 무력했던 **일곱 번째** 사례다. "
                      "앞의 여섯과 같은 모양 — 필드 이름이 약속하는 것과 코드가 재는 것이 다르다.",
