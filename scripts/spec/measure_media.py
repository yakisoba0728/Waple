    ...
    entries = [
        ...
        specfmt.entry("engine.media.mediaextensions.weExports", {
            ...
            "signatures": {
                ...
                "CreateMediaExtensions": "미복원. 반환형·인자 개수를 확인하지 않았다",
                "WallpaperEngineMedaExtensionVersion": "미복원",
            },
        }, "확정", [bin_ev, script_ev]),
        ...
        specfmt.entry("engine.media.color.hdrProbe", {
            ...
            "note": "이 프로브가 읽는 색 속성은 이 둘뿐이다. 행렬·레인지·크로마사이팅은 읽지 않는다. "
                   ...
                   specfmt.ev("binary", "wallpaper64.exe IAT 0x140426690/0x140426698 참조 전수 — "
                                        "각각 호출 지점 1곳(0x1401200a1, 0x1400f2b8b)"),
                   script_ev]),
        ...
        specfmt.entry("engine.media.audio.paths", {
            "sceneAudio": {
                ...
                "entry": "CreateMediaExtensions (LoadLibraryW 로 동적 로드)",
        ...
        specfmt.entry("engine.media.unknowns", {
            ...
            "mediaextensions64.dll 의 WE 전용 export 2개 시그니처":
                "CreateMediaExtensions(ordinal 1, 0x180002808) 와 "
                "WallpaperEngineMedaExtensionVersion(ordinal 2, 0x1803119e0) 의 시그니처를 "
                "복원하지 않았다. 오디오 경로라 비디오 질문에 영향이 없어 우선순위를 낮췄다.",
