...
| 코퍼스 있음(축소 38, release) | 2,183 | 9 | **162초** | 2026-08-16 실측 — `verify-plan-b12.sh` §5 (`swift test -c release`, 순차) |
| 코퍼스 있음(축소 38, debug) | 2,183 | 9 | ~4.6분 | 2026-08-16 실측 (`--parallel --num-workers 6`, 아래 레시피) |
| 코퍼스 없음 | 2,183 | 40 | ~110초 | 2026-08-17 macOS 실측 (`WAPLE_REAL_PKGS=/nonexistent/path swift test`, 순차) |
| CI (코퍼스 없음) | 2,183 | 47 | ~170초 | 2026-08-16 확인 — CI run `30934767197`(main @`b901326`, macos-26, 성공) 로그 |
