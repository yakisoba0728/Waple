...
final class TexImageTests: XCTestCase {
    ...
    static func makeTex(format: Int, w: Int, h: Int, payload: [UInt8]) -> Data {
        ...
        b += bytes(i32(format), i32(0), i32(w), i32(h), i32(w), i32(h))
        b += tag("TEXB0001")
        b += payload
        return Data(b)
    }
    ...
    func testParsesFormat9AsR8() {
        ...
        b += bytes(i32(9), i32(0), i32(8), i32(8), i32(8), i32(8))                  // format=9
        b += bytes(tag("TEXB0004"), i32(1), i32(-1), i32(0), i32(1))                // imageCount, fmt, v4, mipCount
        b += bytes(i32(8), i32(8), i32(0), i32(64), i32(r8.count), r8)              // w,h,isLZ4=0,dec=64,comp,payload
    ...
    func testLZ4PayloadWithFakeJPEGSignatureIsNotEmbeddedJPEG() {
        ...
        var b = bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(0), i32(0), i32(8), i32(8), i32(8), i32(8))                  // format=0
        b += bytes(tag("TEXB0004"), i32(1), i32(-1), i32(0), i32(1))                // imageCount, imageFormat=-1, v4, mipCount
        b += bytes(i32(8), i32(8), i32(1), i32(256), i32(lz4ish.count), lz4ish)     // w,h,isLZ4=1,dec=8*8*4,comp,payload
        let t = TexImage.parse(Data(b))
    ...
    func testVideoFlagWithRawContainerRoutesToVideo() {
        ...
        var b = bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(0), i32(0x22), i32(8), i32(8), i32(8), i32(8))                // format=0, flags=ClampUV|IsVideoTexture
        b += bytes(tag("TEXB0003"), i32(1), i32(-1), i32(1))                         // imageCount, imageFormat=-1, mipCount
        b += bytes(i32(8), i32(8), i32(0), i32(0), i32(mp4ish.count), mp4ish)        // w,h,isLZ4=0,dec=0,comp,payload
        let t = TexImage.parse(Data(b))
    ...
    func testParsesFlags() {
        ...
        var b = bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(0), i32(0x25), i32(4), i32(4), i32(4), i32(4))
        b += bytes(tag("TEXB0001"), [0, 0, 0, 0])
        let t = TexImage.parse(Data(b))
    ...
    func testParsesMultiMipTEXB0004() {
        ...
        var b: [UInt8] = []
        b += bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(4), i32(0), i32(8), i32(8), i32(8), i32(8))     // format=4
        b += tag("TEXB0004")
        b += bytes(i32(1), i32(-1), i32(0))                           // imageCount, imageFormat, v4 필드
        b += i32(2)                                                   // mipCount=2
        b += bytes(i32(8), i32(8), i32(1), i32(64), i32(mip0.count), mip0)  // mip0
        b += bytes(i32(4), i32(4), i32(1), i32(16), i32(mip1.count), mip1)  // mip1
        let t = TexImage.parse(Data(b))
    ...
    func testParsesTEXB0004WithConditionJSONBeforeMipTable() {
        ...
        var b: [UInt8] = []
        b += bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(4), i32(0), i32(8), i32(8), i32(8), i32(8))
        b += tag("TEXB0004")
        b += bytes(i32(1), i32(-1), i32(1))                        // imageCount, fmt, v4(변형수 1)
        b += bytes(i32(1), i32(1), i32(0), Array(condition.utf8), [0])  // 변형 블록: [1][idx][0][json]
        b += i32(1)                                                // mipCount
        b += bytes(i32(8), i32(8), i32(1), i32(64), i32(payload.count), payload)
        let t = TexImage.parse(Data(b))
        XCTAssertEqual(t?.payload, .bc3)
        XCTAssertEqual(t?.mip?.decompressedSize, 64)
    ...
    func testParsesTEXB0004MultiVariantConditionChain() {
        ...
        var b: [UInt8] = []
        b += bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(4), i32(0), i32(64), i32(32), i32(64), i32(32))
        b += tag("TEXB0004")
        b += bytes(i32(1), i32(-1), i32(3))                            // imageCount, fmt=-1, v4(변형수 3)
        b += bytes(i32(1), i32(1), i32(0), cond(2), [0])               // 변형1
        b += bytes(i32(1), i32(2), i32(0), cond(1), [0])               // 변형2
        b += bytes(i32(1), i32(3), i32(0), cond(3), [0])               // 변형3
        b += i32(1)                                                    // mipCount(변형1의 mip 세트)
        b += bytes(i32(64), i32(32), i32(0), i32(0), i32(payload.count), payload)  // isLZ4=0
    ...
    func testParsesMultiImagePages() {
        ...
        var b = bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(0), i32(0), i32(1), i32(1), i32(1), i32(1))     // fmt0, 1x1
        b += bytes(tag("TEXB0003"), i32(2), i32(-1))                   // imageCount=2, imageFormat=-1
        b += bytes(i32(1), i32(1), i32(1), i32(0), i32(4), i32(4), page0)   // image0: mipCount1, w,h,isLZ4=0,dec,comp,payload
        b += bytes(i32(1), i32(1), i32(1), i32(0), i32(4), i32(4), page1)   // image1
        let t = TexImage.parse(Data(b))
    ...
    func testParsesFormat7AsBC1() {
        ...
        var b: [UInt8] = []
        b += bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(7), i32(0), i32(8), i32(8), i32(8), i32(8))
        b += tag("TEXB0004")
        b += bytes(i32(1), i32(-1), i32(0), i32(1))                // imageCount, fmt, v4, mipCount
        b += bytes(i32(8), i32(8), i32(0), i32(0), i32(bc1))       // w, h, isLZ4=0(비압축), dec, comp
    ...
    private func makeBC3Tex(w: Int, h: Int, payload: [UInt8], format: Int = 4) -> Data {
        ...
        b += tag("TEXB0003")
        b += i32(1)                       // mipCount
        b += bytes(i32(-1), i32(1), i32(w), i32(h), i32(1))  // leading ints
        b += bytes(i32(dxt5), i32(payload.count))            // decompressedSize, compressedSize
        b += payload
        return Data(b)
    }
    ...
    private func makeLZ4RGBATex(texW: Int, texH: Int, imgW: Int, imgH: Int, payload: [UInt8]) -> Data {
        var b = bytes(tag("TEXV0005"), tag("TEXI0001"))
        b += bytes(i32(0), i32(0), i32(texW), i32(texH), i32(imgW), i32(imgH))   // format=0
        b += bytes(tag("TEXB0003"), i32(1), i32(-1), i32(1), i32(texW), i32(texH), i32(1),
                   i32(texW * texH * 4), i32(payload.count))
        b += payload
        return Data(b)
    }
    ...
    func testRejectsNegativeTEXSFrameTime() {
        ...
        texs += bytes(i32(1), i32(4), i32(4))
        texs += bytes(i32(0), f32(-1), f32(0), f32(0), f32(4), f32(0), f32(0), f32(4))
